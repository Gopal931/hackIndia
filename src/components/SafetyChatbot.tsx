    ...
    try {
      ...
      if (error instanceof Error) {
        if (error.message === 'CREDIT_LIMIT') {
          return "I apologize, but the AI advice service is currently unavailable due to usage limits. Please try:\n\n1. Using the Emergency Services mode for immediate help\n2. Try again in a few minutes\n3. For emergencies, always call your local emergency number (like 911)";
        }
        
        if (error.message.includes('API key')) {
          return "The AI advice service is not properly configured. Please contact support to enable this feature. In the meantime, you can use the emergency services mode to find nearby help.";
        }
      }
      
      return "I'm having trouble providing advice right now. If you need immediate help, please switch to emergency services mode or contact emergency services directly. For emergencies, always call your local emergency number (like 911).";
    }
  };
